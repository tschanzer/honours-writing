...
Having presented the preliminary theory, I will now review previous studies on
the numerical solution of the \rb{} problem to determine the nature of the
errors that one should expect to obeserve between an under-resolved model and
a high-resolution ``truth'' model. The rationale is that, if the resolutions
of the high- and low-resolution models are chosen
...
% this figure may not be necessary, just describe in text
\begin{figure}[ht]
    \centering
